...
class _DashboardScreenState extends State<DashboardScreen> {
  ...
  void _createNewPage() async {
    ...
    if (!mounted) return;
    final created = SheetPage(id: id, title: page.title, createdAt: page.createdAt, sortOrder: _pages.length);
    _openPage(created);
  }
  ...
  Future<void> _deletePage(SheetPage page) async {
    ...
    if (mounted) {
      ScaffoldMessenger.of(context).showSnackBar(const SnackBar(content: Text('Sayfa silindi.')));
      _loadPages();
    }
  }
                    ...
                    itemBuilder: (context, i) {
                      ...
                      return ReorderableDragStartListener(
                        ...
                        child: _PageCard(
                          ...
                          recordCount: page.id != null ? (_recordCounts[page.id!] ?? 0) : 0,
                        ),
                      );
                    },
                  ),
...
class _PageCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final title = page.title?.isNotEmpty == true ? page.title! : 'Sayfa #${page.id}';
    ...
    return Card(
      ...
      child: InkWell(
        ...
        child: Padding(
          ...
          child: Row(
            children: [
              Icon(Icons.drag_handle_rounded, color: theme.colorScheme.onSurfaceVariant, size: 22),
              const SizedBox(width: 12),
              Container(
                width: 44,
                height: 44,
                ...
                child: Icon(Icons.description_rounded, color: theme.colorScheme.onPrimaryContainer, size: 22),
              ),
              ...
              Material(
                ...
                child: InkWell(
                  ...
                  child: Padding(
                    padding: const EdgeInsets.all(12),
                    child: Icon(Icons.more_vert_rounded, color: theme.colorScheme.onSurface),
                  ),
                ),
              ),
